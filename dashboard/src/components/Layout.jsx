...
export default function Layout({ children }) {
  ...
  const userName = user?.name || 'Celia';
      ...
      <div className="layout">
        <aside className={`sidebar ${collapsed ? 'sidebar--collapsed' : ''}`}>
          <div className="sidebar-header">
            <div className="sidebar-brand">
              ...
              <div className="sidebar-brand-text">
                ...
                <span className="sidebar-subtitle">Espace gestion</span>
              </div>
            </div>
            <button
          ...
          <nav className="sidebar-nav">
            <NavGroup label="Agenda" items={mainNavItems} collapsed={collapsed} />
            <NavGroup label="Suivi" items={secondaryNavItems} collapsed={collapsed} />
          </nav>

          <div className="sidebar-footer">
            <div className="sidebar-user" onClick={handleLogout} title="Deconnexion">
        ...
        <main className={`main-content ${collapsed ? 'main-content--sidebar-collapsed' : ''}`}>
          {children}
        </main>
      </div>
    );
